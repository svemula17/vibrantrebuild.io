  ...
  return (
    <>
      <PageHero
        ...
        description="From AI readiness and cloud modernization to SAP S/4HANA implementation and managed IT — 17 specialized capabilities delivered by certified practitioners with 25 years of trusted delivery."
